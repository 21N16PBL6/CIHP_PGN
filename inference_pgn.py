...
def main():
    ...
    with tf.name_scope("create_inputs"):
        ...
        image = reader.image
        image = tf.image.resize(image, [256, 192])
    ...
    # evaluate prosessing
    parsing_dir = '../output/image-parse-v3'
    ...
    for step in range(NUM_STEPS):
        ...
        image = cv2.resize(image.astype(np.uint8), (768, 1024), interpolation=cv2.INTER_LINEAR)
        # print(image.shape)
        cv2.imwrite('{}/{}.png'.format(parsing_dir, img_id), image)
        # print("here")
